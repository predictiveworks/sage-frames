package de.kp.works.sage.logging
...
object SageLogger {
  ...
  private val loggingCfg = SageConf.getLoggingCfg
  ...
  private def buildLogger:Logger = {
    ...
    logFileAppender.setFile(s"${getFolder}sage.log");
    /*
     ...
     */
    val logger = logCtx.getLogger("SageFrames")
